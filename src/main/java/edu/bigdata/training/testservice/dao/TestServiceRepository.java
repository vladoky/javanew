...
public class TestServiceRepository {
    ...
    public PersonEntity update(PersonEntity personEntity) { return ignite.getOrCreateCache(personCacheConfiguration).getAndReplace(personEntity.getId(), personEntity);}
